...
<script type="text/javascript" src="js/val.js"></script>
		<div class="col-md-9">
			...
			<div class="row">
				<div class="col-md-10 offset-md-2 by">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							...
							<div class="form-group">
								<label>Address</label>
								<textarea id="add"placeholder="Address"  name="address" class="form-control"></textarea>
						...
						<div class="card-footer">
							<button type="submit" id="submit-btn"  class="btn btn-dark">Sign Up</button>
						</div>
