                   ...
                   <div class="row">
                       ...
                       <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card bg-dark text-light">
                             ...
                             <h3 class="text-center">Edit-Your-Property</h3>
                              </div>
             <div class="card-body">
             	<form action="property_update.php" method="post" enctype="multipart/form-data">
...
<option>Select</option>
<option <?php if($data['perpose']=="For Rent") echo "selected='selecded' ";  ?>>For Rent</option>
<option <?php if($data['perpose']=="For Sell") echo "selected='selecded' ";  ?>>For Sell</option>
...
<textarea name="detail" class="form-control"><?php echo $data['detail'] ?></textarea>
                        ...
                        <div class="card-footer">
                          <!-- <a href="update_property.php" class="btn btn-secondary">Update</a> -->
