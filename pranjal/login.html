...
<body>
		...
		<img src="image/home.PNG" class="img-thumbnail">
	</div>
	...
	<nav class="navbar bg-danger navbar-expand-sm navbar-dark sticky-top">
		<a href="#" class="navbar-brand">Makan.com</a>
		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item">
				<a href="#" class="nav-link"><i class="fa fa-lock" aria-hidden="true"></i>  Login </a>
			</li>
			<li class="nav-item">
				<a href="signup.html" class="nav-link"><i class="fa fa-user-plus" aria-hidden="true"></i> Signup</a>
			</li>
		</ul>
		</div>
	</nav>
					...
					<div class="row">
						<div class="col-md-8 offset-md-2" >
							<div class="card bg-dark text-light">
								<div class="card-header"><h5>User Login, for New User<a href="signup.html"> Click here</a> </h5>
							</div>
							<div class="card-body">
...
<br />
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<h5 class="text-light p-3 text-center bg-danger m-3">Contact Us</h5>
						...
						<div class="row p-2">
							...
							<div class="col-md-6">
								<div class="form-group text-light">
									<label>Message</label>
									<textarea rows="3" placeholder="" class="form-control"></textarea>
								</div>
								<button class="btn btn-primary btn-sm d-block float-right">Send</button>
							</div>
						</div>
					 </div>
				</div>
