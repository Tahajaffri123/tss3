...
<body>
	...
	<ul class="pagination justify-content-center">
		...
		<li class="page-item <?php if($a==1) echo "disabled";?>">
			<a href="pagination2.php?pageno=<?php echo $a-1;?>" class="page-link">pre</a>
		</li>
		<?php
		...
		<li class="page-item <?php if($i==$a) echo "active";?>">
			<a href="pagination2.php?pageno=<?php echo $i;?>" class="page-link"><?php echo $i;?></a>
		</li>
		<?php
		}
		?>
		<li class="page-item <?php if($a==$total_pages) echo "disabled";?>">
			<a href="pagination2.php?pageno=<?php echo $a+1;?>" class="page-link">Next</a>
		</li>
	</ul>
